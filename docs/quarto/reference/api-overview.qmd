...
|--------------------------|-------------|
| `__init__(...)`          | Create a dataset from any `__arrow_c_stream__` source. |
...
Full API documentation: [batchcorder.CachedDataset](../autoapi/batchcorder/index.rst).

## `CachedDatasetReader`

A single-use iterator handle. Maintains its own position in the batch
sequence. Obtain one via `CachedDataset.reader()` — do not construct directly.
...
Full API documentation: [batchcorder.CachedDatasetReader](../autoapi/batchcorder/index.rst).
