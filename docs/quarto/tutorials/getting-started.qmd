...
- `StreamCache` wraps any Arrow stream and stores batches in a memory or
  disk cache.
...
- [Configure cache storage](../how-to/cache-config.md) to choose between
  memory and disk modes.
- [Concurrent reads](../how-to/eviction.md) for multi-threaded patterns.
