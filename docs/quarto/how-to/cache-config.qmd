...
Once all `max_readers` readers have been created and consumed, no further
readers can be obtained.  When `max_readers` is omitted (default), all
batches are retained indefinitely and unlimited readers are allowed.
